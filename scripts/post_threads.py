...
# ── 관계형 참여 콘텐츠 (화·목·일) ────────────────────
# 계정에서 실제로 반응이 좋았던 것은 답하기 쉬운 질문형 글이었다. 단순 홍보 문구보다
# 두 선택지 중 하나를 고르게 하고, 더 자세히 보고 싶은 사람만 테스트로 이어지게 한다.
RELATION = [
    ("연락이 늦으면\n서운하다고 바로 말하는 편 vs 아무렇지 않은 척 기다리는 편\n어느 쪽임?",
     "relation.html", "나는 어떤 대화형인지 여기서 해봄"),
    ("싸우면 그날 풀어야 잠드는 사람\n하루 지나야 말이 정리되는 사람\n둘이 만나면 진짜 어렵더라",
     "relation.html", "서로 다른 대화 유형 확인하기"),
    ("상대가 힘들다고 할 때\n위로 먼저 vs 해결책 먼저\n이 차이로 은근히 서운해짐",
     "relation.html", "내 연애 대화 유형은 여기"),
    ("좋아한다는 말 자주 듣기 vs 행동으로 확인하기\n둘 다 좋지만 하나만 고르면 뭐임?",
     "relation.html", "10문항으로 내 유형 확인하기"),
    ("답장 쓰다가 지우는 편\n생각나는 대로 바로 보내는 편\n나는 전자라 한 문장에 오래 걸림",
     "relation.html", "대화할 때 내 성향 보기"),
    ("약속 잡을 때\n날짜부터 딱 정하는 사람 vs 분위기 보고 천천히 정하는 사람\n너무 다르면 시작부터 힘듦",
     "relation.html", "우리 대화 방식은 어느 쪽인지 보기"),
    ("서운한 일이 생기면\n말로 풀어야 끝나는 사람 vs 혼자 정리돼야 말하는 사람\n다들 어느 쪽임?",
     "relation.html", "연애 대화 유형 테스트"),
]

# ── 특가 (수동 실행 전용) : 사이트 특가 페이지로 보내는 글 ──
